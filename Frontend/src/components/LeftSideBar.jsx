...
function LeftSidebar(props) {
  ...
  return (
    <>
      <div
        className={`flex flex-col gap-4 p-8 border-2 rounded-r-3xl border-t-0 border-l-0 shadow-xl ${appColors.appTheme == "light" ? "border-blue-300 " : "border-neutral-900"} border-opacity-25 max-h-screen`}
      >
        <input
          type="text"
          name="search"
          id="searchbox"
          placeholder="Search"
          className=" max-w-40 mb-4 bg-slate-200 rounded pl-4 mx-auto h-6"
          value={props.search}
          onChange={(evt) => {
